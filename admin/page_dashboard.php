...
?>
    <div class="main">
        <ul>
            <?php
            // Teams, players, volunteers, signups and matches
            foreach (array('fcmanager_team', 'fcmanager_player', 'fcmanager_volunteer', 'fcmanager_signup', 'fcmanager_match') as $post_type) {
